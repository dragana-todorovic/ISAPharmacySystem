$(document).ready(function(e){
    btnAdd = document.getElementById("submitRegisterDermatologist")
        btnAdd.disabled = true
         ...
         $('#txtSubstituteMedicineCodes').keyup(function () {
          if($('#txtEmail').val() != '' && validateEmail($('#txtEmail').val()) && validatePassword($('#txtPassword').val())  &&  $('#txtPassword').val()!= '' && $('#txtFirstName').val()!= '' && $('#txtLastName').val() &&   $('#txtCountry').val() != ''  &&  $('#txtCity').val()!= '' && $('#txtAddress').val()!= '' && $('#txtNumber').val()!='' ){
            ...
            $('#txtNotes').keyup(function () { if($('#txtEmail').val() != '' && validateEmail($('#txtEmail').val()) && validatePassword($('#txtPassword').val())  &&  $('#txtPassword').val()!= '' && $('#txtFirstName').val()!= '' && $('#txtLastName').val() &&   $('#txtCountry').val() != ''  &&  $('#txtCity').val()!= '' && $('#txtAddress').val()!= '' && $('#txtNumber').val()!='' ){
                                                                      btnAdd.disabled = false
                                                                      }
                  if($('#txtNotes').val() == ''){
                      btnAdd.disabled = true
