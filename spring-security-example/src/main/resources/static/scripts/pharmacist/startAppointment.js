...
var result=false;
	 ...
	 $("#startAppointment").click(function () {
		...
		customAjax({
		      url: '/pharm/getPatientsForAppointment/' + email,
		      method: 'GET',
...
$("#surname").keyup(function () {
 ...
 $("input:button[name=finish]").click(function () {
	...
	console.log(this.id)
	customAjax({
		      url: '/pharm/giveOnePenalForPatient/' + id,
		      method: 'POST',
		      success: function(){
 ...
 $("input:button[name=start]").click(function () {
	...
	customAjax({
			...
			var id = p.id
			customAjax({
		      url: '/pharm/getMedicinesOnWhichPatientIsNotAllergic/' + id,
		      method: 'GET',
...
customAjax({
		      url: '/pharm/getPatientWhoIsAtAppointment/'+idStart,
		      method: 'GET',
...
$('#schedule').click(function(){	
	...
	obj = JSON.stringify({pharmacistEmail:pharmacistEmail,startDate:startDate,startTime:startTime,patientEmail:patientEmail,duration:duration});
			customAjax({
		        method:'POST',
...
$('#btnAvailability').click(function(){
	...
	if(medicineName==""){
		...
		customAjax({
		      url: '/pharm/checkMedicineAvailability/' + medicineId + "/"+email,
		      method: 'POST',
			...
			if(result==true){
				...
				customAjax({
		      url: '/pharm/getSubstituteMedicine/' + medicineId +"/"+idStart,
		      method: 'GET',
...
$('#btnSpecification').click(function(){
	...
	if(medicineName==""){
		...
		console.log(medicineId)
		customAjax({
		      url: '/pharm/getSpecificationForMedicine/' + medicineId,
		      method: 'GET',
